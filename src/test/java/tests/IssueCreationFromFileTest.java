...
public class IssueCreationFromFileTest extends BaseTest{
    ...
    public IssueCreationFromFileTest(String title, String body, List<String> labels){
        this.title = title;
        this.body = body;
        this.labels = labels;
    }
    ...
    public static List<Object[]> data() {
        ...
        List<String> dataFromFile = readFile("D:\\QAlight\\G48_Automation_Galchinskij\\src\\test\\resources\\testData\\issueCreationData");
